...
The Global Digital Infrastructure Political Economy Observatory is built as an open ecosystem, not a closed lab project. The dataset is more useful and more accurate when people outside the project team can check it, extend it, and build on it. This guide explains the ways to take part.
...
The discovery pipeline searches public sources, but coverage is uneven. Coverage of foreign trade press, foreign regulatory filings, and non-English-language sources is currently thin relative to their importance.
